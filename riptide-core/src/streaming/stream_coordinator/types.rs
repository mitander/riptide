...
use crate::torrent::{
    EnhancedPeerManager, HttpTrackerClient, InfoHash, NetworkPeerManager, TorrentEngine,
    TorrentError,
};
...
pub struct StreamCoordinator {
    ...
    pub(super) _torrent_engine: Arc<RwLock<TorrentEngine<NetworkPeerManager, HttpTrackerClient>>>,
